...
fun rememberMapViewWithLifecycle(): MapView {
    ...
    DisposableEffect(key1 = lifecycle, key2 = mapView) {
        // Make MapView follow the current life cycle
        val mapLifecycleObserver = getMapLifecycleObserver(mapView)
        // Add observer to life cycle
        lifecycle.addObserver(mapLifecycleObserver)

        onDispose {
            // Clean up code after leaving composition
